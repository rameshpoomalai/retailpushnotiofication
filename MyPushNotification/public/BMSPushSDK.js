...
function BMSPush() {
    ...
    */
    ...
    function sendMessage(message) {
    	printLog("sendMessage invoked " + message);
        return new Promise(function(resolve, reject) {
            ...
            messageChannel.port1.onmessage = function(event) {
                if (event.data.error) {
                	...
                	printLog("Resolve now with " + event.data);
                    resolve(event.data);
            ...
            if (navigator.serviceWorker &&
            	...
            	navigator.serviceWorker.addEventListener('message', function(event){
          		  ...
          		  if(command === 'msgEventOpen' ) {
        			  ...
        			  printLog("The strpayload of the message is " + strPayload);
        ...
        function createChromeNotification(msgIconUrl) {
            ...
            chrome.notifications.create(nid, notification, function(notificationId) {
            	chrome.storage.local.get('deviceId', function(result) {
                    ...
                    BMSPushBackground.printLogExt("status str " + JSON.stringify(statusObj));
                    BMSPushBackground.printLogExt("The nid of the message is " + notificationId);

...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        push.initialize(this, "aa112626-adbb-4276-9b6c-635554eb87aa", "06f2cf4b-beda-4de2-9c62-463c76664471");
            ...
            public void onReceive(final MFPSimplePushNotification message) {
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        final TextView responseText = (TextView) findViewById(R.id.top_text);
                        try
                        {


                            JSONObject payloadResponse = new JSONObject(message.getPayload());
                            Log.i(TAG, "Alert: " +message.getAlert());
                            if(message.getAlert().contains("offers"))
                            {
                                Log.i(TAG, "ProductDesc: " +payloadResponse.getString("ProductDesc"));
                                responseHTML = "New Offers for you:"+payloadResponse.getString("ProductDesc") +" : "+ payloadResponse.getString( "Promo");
                                ...
                                String tempresponseHTML =              "Stockup Action > Product        : "+ payloadResponse.getString("ProductDesc")+" , " +"Expected Sales : "+payloadResponse.getJSONObject( "expectedSales").getString("Sale") +" , ";
                                tempresponseHTML = tempresponseHTML+"Current Stock  : "+ payloadResponse.getString( "Stock") +" , ";
                                //responseHTML = responseHTML+"Stock Required : "+ (payloadResponse.expectedSales.Sale - payloadResponse.Stock )+"";
                                responseHTML = tempresponseHTML;
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    responseText.setText(responseHTML );
                                }
                            });
                            Log.i(TAG, "Response: "+responseHTML);

                        }
                        catch(Exception exp)
                        {
                            Log.i(TAG, "err: "+exp);
                            responseText.setText("Error"+exp.getMessage() );
                        }
